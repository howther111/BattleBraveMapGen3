...
land_line = forest - random.randint(0, 150) #以上は高山
land = max(-70, land_line) #以上は平地
sand_line = land - random.randint(5, 50)
sand = max(-80, sand_line) #以上は砂地
normalsea_line = sand - random.randint(0, 100)
normalsea = max(-90, normalsea_line) #以上は通常水地
deepsea = -100 #以上は深水
